...
Trong 12 tuần này, tôi đã chuyển đổi từ việc làm quen với các khái niệm Cloud cơ bản sang việc xây dựng và tối ưu hóa một ứng dụng Serverless hoàn chỉnh trên AWS.
...
| **Tuần 2** | [Tìm hiểu chuyên sâu về **Amazon EC2 và VPC**, chuẩn bị tài nguyên, và tham gia **sự kiện Cloud Day** để trau dồi kiến thức về AI/Data.](1.2-week2/) |
| **Tuần 3** | [Khắc phục sự cố tài khoản, tìm hiểu và thiết lập các kết nối mạng phức tạp (**Hybrid DNS** với **Route 53 Resolver** và **VPC Peering**).](1.3-week3/) |
| **Tuần 4** | [Học **AWS Transit Gateway** để quản lý mạng quy mô lớn, tìm hiểu sâu về các tính năng của **EC2**, và chuẩn bị ý tưởng cho Proposal.](1.4-week4/) |
